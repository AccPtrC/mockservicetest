		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Mock Service",
									"targetURL": "#odatamockservice-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"odatamockservice-display": {
								"semanticObject": "odatamockservice",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=odatamockservice",
									"url": sap.ui.require.toUrl("odatamockservice")
								}
							}
						}
					}
